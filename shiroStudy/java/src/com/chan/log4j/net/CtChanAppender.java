...
public class CtChanAppender extends AppenderSkeleton {

    static public final int DEFAULT_PORT = 39999;
    ...
    public CtChanAppender() {
    }

    /**
     * Connects to remote server at <code>address</code> and <code>port</code>.
     */
    public CtChanAppender(InetAddress address, int port) {
     ...
     */
    public CtChanAppender(String host, int port) {
        this.port = port;
